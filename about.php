        ...
        <div class="container">
          <div class="row d-flex justify-content-center text-center">
            <div class="col-lg-8">
              ...
              <p class="mb-0">
               We are dedicated to providing compassionate, high-quality healthcare services 
               that promote wellness and improve the lives of the communities we serve.
              </p>
            </div>
          </div>
        </div>
          ...
          <div class="col-lg-6" data-aos="fade-right" data-aos-delay="100">
            <div class="about-content">
              ...
              <div class="stats-grid">
                ...
                <div class="stat-item">
                  <span class="stat-number" data-purecounter-start="0" data-purecounter-end="9" data-purecounter-duration="2">9</span>
