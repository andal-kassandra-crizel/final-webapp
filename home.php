...
<?php include 'includes/header.php'; ?>
  ...
  <main class="main">
          ...
          <div class="col-lg-6">
            <div class="hero-content">
              ...
              <p class="hero-description" data-aos="fade-right" data-aos-delay="400">
                Your trusted local health partner, providing accessible and quality medical services for every member of the community.
              </p>

              <!-- <div class="hero-stats mb-4" data-aos="fade-right" data-aos-delay="500">
                <div class="stat-item">
                  <h3><span data-purecounter-start="0" data-purecounter-end="3" data-purecounter-duration="2" class="purecounter"></span>+</h3>
                  <p>Years Experience</p>
                </div>
                <div class="stat-item">
                  <h3><span data-purecounter-start="0"  data-purecounter-end="1500"  data-purecounter-duration="2" class="purecounter"></span>+</h3>
                  <p>Patients Treated</p>
                </div>
                <div class="stat-item">
                  <h3><span data-purecounter-start="0"  data-purecounter-end="9"  data-purecounter-duration="2" class="purecounter"></span>+</h3>
                  <p>Medical Experts</p>
                </div>
              </div> -->
          ...
          <div class="col-lg-6 mb-5 mb-lg-0" data-aos="fade-right" data-aos-delay="200">
            <div class="about-content">
              ...
              <div class="stats-grid">
                <div class="stat-item">
                  <div class="stat-number purecounter" data-purecounter-start="0" data-purecounter-end="1500" data-purecounter-duration="1"></div>
        ...
        <div class="row g-5">
            ...
            <div class="specialty-card">
              <div class="specialty-content">
                <div class="specialty-meta">
                  <span class="specialty-label">Essential Care</span>
                </div>
                ...
                <div class="specialty-features">
                 <span><i class="bi bi-check-circle-fill"></i> Consultation and Check-ups</span>
                 <span><i class="bi bi-check-circle-fill"></i> Physical Examinations</span>
                 <span><i class="bi bi-check-circle-fill"></i> Vital Signs Monitoring</span>
                </div>
                <!-- <a href="service-details.html" class="specialty-link">
                   Explore General Care <i class="bi bi-arrow-right"></i>
                </a> -->
              </div>
          ...
          <div class="col-lg-6" data-aos="zoom-in" data-aos-delay="200">
            <div class="specialty-card">
              <div class="specialty-content">
                <div class="specialty-meta">
                  <span class="specialty-label">Healthy Smiles</span>
                </div>
                <h3>Dental Services</h3>
                <p>Comprehensive oral health services including prevention, restoration, and cosmetic treatments.</p>
                <div class="specialty-features">
                 <span><i class="bi bi-check-circle-fill"></i> Cleaning & Check-ups</span>
                 <span><i class="bi bi-check-circle-fill"></i> Tooth Extraction & Fillings</span>
                 <span><i class="bi bi-check-circle-fill"></i> Braces, Dentures, & Crowns</span>
                </div>
                <!-- <a href="service-details.html" class="specialty-link">
                   Explore Dental Care <i class="bi bi-arrow-right"></i>
                </a> -->
              </div>
              <div class="specialty-visual">
                <img src="assets/img/health/dental-care.webp" alt="Dental Services" class="img-fluid">
                <div class="visual-overlay">
                  <i class="bi bi-cpu"></i>
                </div>
              </div>
           ...
           <!-- Preventive & Emergency Care -->
    <div class="col-lg-6" data-aos="zoom-in" data-aos-delay="300">
     <div class="specialty-card">
      <div class="specialty-content">
        <div class="specialty-meta">
          <span class="specialty-label">Care & Response</span>
        </div>
        ...
        <div class="specialty-features">
          <span><i class="bi bi-check-circle-fill"></i> Vaccination & Health Counseling</span>
          <span><i class="bi bi-check-circle-fill"></i> Minor Procedures & Suturing</span>
          <span><i class="bi bi-check-circle-fill"></i> 24/7 Emergency Assistance</span>
        </div>
        <!-- <a href="department-details.html" class="specialty-link">
          Explore Care <i class="bi bi-arrow-right"></i>
        </a> -->
      </div>
      <div class="specialty-visual">
        <img src="assets/img/health/emergency-care.webp" alt="Emergency Care" class="img-fluid">
        <div class="visual-overlay">
          <i class="bi bi-heart-pulse"></i>
        </div>
      </div>
    </div>
    </div><!-- End Preventive & Emergency Care -->
    ...
    <section id="find-a-doctor" class="find-a-doctor section">
      ...
      <div class="container section-title" data-aos="fade-up">
        <h2>Find A Doctor</h2>
        <p>Quickly find experienced doctors suited to your health concerns. From general care to specialized treatments, 
          our medical professionals are ready to provide safe, reliable, and compassionate healthcare.</p>
      </div><!-- End Section Title -->
        ...
        <div class="doctors-grid" data-aos="fade-up" data-aos-delay="300">
          ...
          <div class="doctor-profile" data-aos="zoom-in" data-aos-delay="200">
            <div class="profile-header">
              ...
              <div class="doctor-details">
                ...
                <span class="specialty-tag">General Physician</span>
                <div class="experience-info">
                  <i class="bi bi-award"></i>
          ...
          <div class="doctor-profile" data-aos="zoom-in" data-aos-delay="300">
            <div class="profile-header">
              ...
              <div class="doctor-details">
                ...
                <span class="specialty-tag">Dentist</span>
                <div class="experience-info">
                  <i class="bi bi-award"></i>
          ...
          <div class="doctor-profile" data-aos="zoom-in" data-aos-delay="400">
            <div class="profile-header">
              ...
              <div class="doctor-details">
                ...
                <span class="specialty-tag">Orthodontist</span>
                <div class="experience-info">
                  <i class="bi bi-award"></i>
          ...
          <div class="doctor-profile" data-aos="zoom-in" data-aos-delay="500">
            <div class="profile-header">
              ...
              <div class="doctor-details">
                <h4>Dr. Nathaniel Torres</h4>
                <span class="specialty-tag">Trauma Medicine</span>
                <div class="experience-info">
                  <i class="bi bi-award"></i>
          ...
          <div class="doctor-profile" data-aos="zoom-in" data-aos-delay="600">
            <div class="profile-header">
              ...
              <div class="doctor-details">
                <h4>Dr. Patricia Gomez </h4>
                <span class="specialty-tag">Critical Care Specialist</span>
                <div class="experience-info">
                  <i class="bi bi-award"></i>
